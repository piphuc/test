local players = game:GetService("Players")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "WiFi Hub";
        Text = "Loading Done!";
        Icon = "rbxthumb://18408414452type=Asset&id=1&w=150&h=150";
        Duration = 10
    })

local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>Skid = Gay <Color=/>"):Display()
wait(0.5)
repeat
    wait()
...
ImageButton.Image = "rbxassetid://18408414452"
...
spawn(function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "WiFi Hub";
        Text = "Loading Done!";
        Icon = "rbxthumb://18404661690type=Asset&id=1&w=150&h=150";
        Duration = 10
    })
